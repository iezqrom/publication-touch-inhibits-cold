...
if __name__ == "__main__":
    ...
    path_animation = checkORcreate(f"{root_path}/data/{folder_name}/animations")
    ...
    for i, n in enumerate(names):
        ...
        if cold_bool[i] == 1:
            ...
            def animate(
                ...
                circles = []
                # print(diff_coor[i])
                # print(np.shape(diff_coor[i]))
                # # print(diff_coor[i])
                # if diff_coor[i][0] == 0:
                #      diff_coor[i] = np.ones((2, 1))
                # elif
            ...
            # mp4_name = 'mp4_' + n
            ani.save(
                f"{root_path}/data/{folder_name}/animations/{mp4_name}.mp4",
                writer=writer,
            )
