...
if __name__ == "__main__":
    ...
    name_files = ["data_replicationsdt_subj"] #, "data_controlsdt_subj"]
    condition_numbers = [2] #, 3]

    for index_file, name_file in enumerate(name_files):
        ...
        for condition in range(0, condition_numbers[index_file]):
