...
if __name__ == "__main__":
    ...
    print(f"Participant folder: {path_day}")
    ...
    if os.path.isdir(f"{path_day}/videos/"):
        videos = os.listdir(f"{path_day}/videos/")
    ...
    path_animation = checkORcreate(f"{path_day}/animations")
    ...
    for video_dot in videos:
        ...
        data = ReAnRaw(f"{path_day}/videos/{video}")
        data.datatoDic()
